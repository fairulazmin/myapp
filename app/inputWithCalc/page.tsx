...
const App = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    console.log("[handleChange]: focusValue:", focusValue);
  };

  const handleCalc = () => {
    try {
      setBlurValue(math.evaluate(focusValue).toString());
      console.log("[handleCalc]: blurValue:", blurValue);
    } catch (error) {
  ...
  const handleFocus = () => {
    ...
    console.log("[handleFocus]: focusValue:", focusValue);
  };

  const handleBlur = () => {
    setInputValue(blurValue);
    console.log("[handleBlur] blurValue:", blurValue);
  };
